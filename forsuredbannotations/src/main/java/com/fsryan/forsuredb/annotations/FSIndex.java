 ...
 * }
 * </code></pre>
 * Using {@link FSIndex} and {@link Unique}:</br>
 * <pre><code>   public interface MyTable extends FSGetApi {
 *    {@literal @}FSColumn("my_column")
 *    {@literal @}Index
 *    {@literal @}Unique
 ...
 * All methods marked with {@link FSIndex}, having the same nonempty compositeId
...
public @interface FSIndex {
    /**
     * <p>Defaults to false. See {@link FSIndex} for more information
