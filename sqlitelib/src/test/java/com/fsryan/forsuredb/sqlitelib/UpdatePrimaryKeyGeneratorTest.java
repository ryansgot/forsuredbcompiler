        ...
        return Arrays.asList(new Object[][] {
                {   // 00: default primary key case when additional column already existed
                        ...
                        new String[] {
                                ...
                                "ALTER TABLE table_name ADD COLUMN long_col INTEGER;",
                ...
                {   // 01: make existing column a primary key (when it wasn't before)
                        ...
                        new String[] {
                                ...
                                "CREATE TEMP TABLE temp_table_name AS SELECT _id, created, deleted, modified, long_col FROM table_name;",
                                "DROP TABLE IF EXISTS table_name;",
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), long_col INTEGER PRIMARY KEY);",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE long_col=NEW.long_col; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, long_col FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 02: make new column a primary key
                        ...
                        new String[] {
                                ...
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), long_col INTEGER PRIMARY KEY);",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE long_col=NEW.long_col; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, null AS long_col FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 03: non-default, non-composite primary key case with on conflict on an existing column
                        ...
                        new String[] {
                                "DROP TABLE IF EXISTS temp_table_name;",
                                "CREATE TEMP TABLE temp_table_name AS SELECT _id, created, deleted, modified, string_col FROM table_name;",
                                "DROP TABLE IF EXISTS table_name;",
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), string_col TEXT PRIMARY KEY ON CONFLICT REPLACE);",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE string_col=NEW.string_col; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, string_col FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 04: non-default, non-composite primary key case with on conflict on a new column
                        ...
                        new String[] {
                                ...
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), string_col TEXT PRIMARY KEY ON CONFLICT REPLACE);",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE string_col=NEW.string_col; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, null AS string_col FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 05: non-default, composite primary key case with no on-conflict new columns
                        ...
                        new String[] {
                                ...
                                "CREATE TEMP TABLE temp_table_name AS SELECT _id, created, deleted, modified FROM table_name;",
                                "DROP TABLE IF EXISTS table_name;",
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), string_col TEXT, string_col_2 TEXT, PRIMARY KEY(string_col, string_col_2));",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE string_col=NEW.string_col AND string_col_2=NEW.string_col_2; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, null AS string_col, null AS string_col_2 FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 06: non-default, composite primary key case with one of the columns existing and one not existing
                        ...
                        new String[] {
                                ...
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), string_col TEXT, string_col_2 TEXT, PRIMARY KEY(string_col, string_col_2));",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE string_col=NEW.string_col AND string_col_2=NEW.string_col_2; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, string_col, null AS string_col_2 FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 07: non-default, composite primary key case with both columns existing
                        ...
                        new String[] {
                                "DROP TABLE IF EXISTS temp_table_name;",
                                "CREATE TEMP TABLE temp_table_name AS SELECT _id, created, deleted, modified, string_col, string_col_2 FROM table_name;",
                                "DROP TABLE IF EXISTS table_name;",
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(" + CURRENT_UTC_TIME + "), string_col TEXT, string_col_2 TEXT, PRIMARY KEY(string_col, string_col_2));",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE string_col=NEW.string_col AND string_col_2=NEW.string_col_2; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, string_col, string_col_2 FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
                },
                {   // 08: non-default, composite primary key case with both columns existing and on conflict
                        ...
                        new String[] {
                                ...
                                "CREATE TEMP TABLE temp_table_name AS SELECT _id, created, deleted, modified, string_col, string_col_2 FROM table_name;",
                                "DROP TABLE IF EXISTS table_name;",
                                "CREATE TABLE table_name(_id INTEGER, created DATETIME DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')), deleted INTEGER DEFAULT '0', modified DATETIME DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')), string_col TEXT, string_col_2 TEXT, PRIMARY KEY(string_col, string_col_2) ON CONFLICT ROLLBACK);",
                                "CREATE TRIGGER table_name_updated_trigger AFTER UPDATE ON table_name BEGIN UPDATE table_name SET modified=" + CURRENT_UTC_TIME + " WHERE string_col=NEW.string_col AND string_col_2=NEW.string_col_2; END;",
                                "INSERT INTO table_name SELECT _id, created, deleted, modified, string_col, string_col_2 FROM temp_table_name;",
                                "DROP TABLE IF EXISTS temp_table_name;"
                        }
